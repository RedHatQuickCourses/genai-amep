...
====
If you already have access to an S3 bucket, an Image Registry (Quay), and the OpenShift AI Model Registry, you can **skip this page** and proceed to xref:modelcar-pipeline.adoc:index.adoc[Model pipeline deployment].
====
