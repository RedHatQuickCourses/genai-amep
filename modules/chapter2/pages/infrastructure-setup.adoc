...
. xref:modelcar-pipeline.adoc[Deploy the ModelCar Pipeline] - Set up model packaging automation
. xref:evaluation-pipeline.adoc[Deploy the Evaluation Pipeline] - Configure model evaluation workflows
