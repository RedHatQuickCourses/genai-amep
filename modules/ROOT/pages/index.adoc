...
*Original solution developed by*: Red Hat AI Customer Adoption and Innovation team (CAI) and can be found here:  https://github.com/rh-aiservices-bu/model-car-importer.git[model-car-importer repository, window=blank]

== What This Step=-by-Step Pipeline Does
